CREATE OR REPLACE FUNCTION functions.inventory_adjunct_get_from_mapping(
    -- IN VARIABLES
    IN i_name text
)
...
BEGIN
    ...
    IF i_name IS NULL OR i_name = '' THEN
        ...
        USING MESSAGE = 'EMPTY_NAME',
            ...
            HINT = 'inventory_adjunct_get_from_mapping';
    END IF;
...
ALTER FUNCTION functions.inventory_adjunct_get_from_mapping OWNER TO shbf_writer;

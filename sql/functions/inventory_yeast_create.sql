CREATE OR REPLACE FUNCTION functions.inventory_yeast_create(
    -- IN VARIABLES
    IN i_name text
)
...
ALTER FUNCTION functions.inventory_yeast_create OWNER TO shbf_writer;

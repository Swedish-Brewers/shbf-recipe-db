CREATE OR REPLACE FUNCTION functions.inventory_yeast_mapping_create(
    -- IN VARIABLES
    IN i_name text
)
...
BEGIN
    ...
    IF i_name IS NULL OR i_name = '' THEN
        ...
        USING MESSAGE = 'EMPTY_NAME',
            ...
            HINT = 'inventory_yeast_mapping_create';
    END IF;
...
ALTER FUNCTION functions.inventory_yeast_mapping_create OWNER TO shbf_writer;
